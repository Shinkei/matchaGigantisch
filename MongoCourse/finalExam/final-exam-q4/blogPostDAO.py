...
class BlogPostDAO:
    ...
    def increment_likes(self, permalink, comment_ordinal):
        ...
        try:
            ...
            comment = 'comments.'+str(comment_ordinal)+'.num_likes'

            last_error = self.posts.update({'permalink': permalink}, {'$inc': {comment: 1}}, upsert=False, manipulate=False, safe=True)
        ...
        return self.get_post_by_permalink(permalink)
